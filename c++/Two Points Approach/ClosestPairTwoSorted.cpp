...
*/
using namespace std;
void FindTwoPointers(vector<int> arr1,vector<int> arr2,int target)
{
    //vector<int> res={0,0}
    int n=arr1.size();
    int m=arr2.size();
    int res_l,res_r,l,r,diff=__INT_MAX__;
    l=0;
    r=n-1;
    while((l<n )&( r>=0))
    {
...
int main()
{
    ...
    vector<int> arr2={3,5,8,10};
    int target=10;
    FindTwoPointers(arr1,arr2,target);
    return 0;
}